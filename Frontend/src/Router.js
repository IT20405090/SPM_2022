...
//customer
import SubmittedAppointment from "./components/customer/SubmitAppointment";
    ...
    <div>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/appointment" element={<SubmittedAppointment />}></Route>
          ...
          <Route
            path="/appointment/viewSubmittedAppointment/:id"
