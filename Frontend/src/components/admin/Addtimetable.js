...
function Addtimetable() {
  ...
  const [Other, setOther]=useState("");
    ...
    <div>
        ...
        <center>
        <h1 style={{marginTop:'-50px',marginBottom:'3px', backgroundColor:'#04619F', color:'white'}}>Fuel Delivery Time Table</h1>
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                            ...
                            <tr>
                            <h5  class="p-3 mb-2  text-Black"   style={{marginLeft:'-18px', color:'white'}}><u>Fuel Dristribution Details</u></h5>
                           </tr>
                           <tr>
                          <td>
                            <div className="form-group" style={{marginBottom:'15px',color:'white'}}>
                            ...
                            <tr>
                             ...
                             <h5 class="p-3 mb-2  text-Black"  style={{marginLeft:'-18px',color:'white'}}><u>Estimate Fuel Dristribution Details</u></h5>
                             </tr>
                             <tr>
                            <td>
                             <div className="form-group" style={{marginBottom:'15px',color:'white'}}>
                        ...
                        <button className= "btn btn-outline-primary" style={{marginRight:'0px', marginLeft:'-640px'}} type="submit" onClick={handleSubmit}>
                         Send Details </button>  
                         &nbsp;&nbsp;&nbsp;&nbsp;
