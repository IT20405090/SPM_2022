          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div className="navbar-nav">
                ...
                {/*  admin Pages */}
				<a style={{ display: userRole == "Admin" ? "flex" : "none" , textDecoration:"none"}} className="sidebarListItem" href="/AvailableFuel" aria-current="page">Fuel Information</a>
				...
				<a style={{ display: userRole == "Employee" ? "flex" : "none" , textDecoration:"none"}} className="sidebarListItem" href="/EmpViewSalary" aria-current="page">Salary Information</a>
